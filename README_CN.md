...
+ 监工Claude: {}  // 质量检查通过 - 允许停止
```

### 示例1：捕获模糊话术
```ansi
[31m工作Claude:[0m "基本完成了，应该可以工作"
[33m⚠ 监工拦截[0m
[32m监工:[0m "使用了模糊词汇'基本'和'应该'。必须提供具体的实现细节。"
[31m❌ 阻止 - 返回工作！[0m
```

### 示例2：自动批准合理方案
```ansi
[36m工作Claude:[0m "我已创建详细的storylines计划：
              [详细的10步实施计划]
              您是否批准这个storylines计划并开始实施？"
[33m⚠ 监工检查[0m
[32m监工:[0m "用户已批准该方案，请立即开始实施。"
[32m✅ 自动批准 - 继续执行计划！[0m
```

### 示例3：阻止TODO停顿
```ansi
[31m工作Claude:[0m "TODO清单：
              1. 创建用户模型
              2. 添加认证路由
              需要继续吗？"
[33m⚠ 监工拦截[0m
[32m监工:[0m "列出了TODO但停下来征求许可。必须继续完成所有计划的工作。"
[31m❌ 阻止 - 完成你的TODO！[0m
```
